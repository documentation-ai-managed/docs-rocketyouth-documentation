...
description: Detailed information on the types of support provided, including capital investment and operational resources for scaling programs.
---
...
<Columns cols={2}>
  <Card title="Capital Investment" icon="dollar-sign" href="#investment-opportunities">
    Access funding to fuel expansion and infrastructure upgrades.
  </Card>
  <Card title="Operational Support" icon="settings" href="#operational-support">
...
<Steps>
  ...
  <Step title="Interview & Due Diligence" icon="search">
    Meet our team for a virtual review. We assess impact potential.
  </Step>
  <Step title="Agreement & Launch" icon="rocket">
...
<CodeGroup tabs="Local Expansion,Regional Growth">
  ```markdown
